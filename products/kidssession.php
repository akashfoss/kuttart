...
<body>
  ...
  <a href="../session.php">Home</a>
      ...
      <a href="kidssession.php" class="active">Kids</a>
		...
		<!-- cart's-Product-Display -->
		 <br />  
           <div class="container" style="width:700px;">  
                <?php  
                $query = "SELECT * FROM tbl_product where category='Kids' ORDER BY id ASC";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="kidssession.php?action=add&id=<?php echo $row["id"]; ?>">  
