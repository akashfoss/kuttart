...
<body>
  ...
  <a href="../session.php">Home</a>
      <a href="mensession.php" class="active">Men</a>
	...
	<div class="banner">
		<div class="banner-layer">
			<h1 class="title-w3layouts">
				<span class="fa fa-cart-arrow-down" aria-hidden="true"></span>Men's collection</h1>
		</div>
		<!-- cart's-Product-Display -->
		 <br />  
           <div class="container" style="width:700px;">  
                <?php  
                $query = "SELECT * FROM tbl_product where category='Mens' ORDER BY id ASC";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="mensession.php?action=add&id=<?php echo $row["id"]; ?>">  
