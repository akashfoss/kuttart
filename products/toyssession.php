...
<body>
  ...
  <a href="../session.php">Home</a>
      ...
      <a href="toyssession.php" class="active">Toys</a>
	...
	<div class="banner">
		...
		<div class="wthreeproductdisplay">
           ...
           <div class="container" style="width:700px;">  
                <?php  
                $query = "SELECT * FROM tbl_product where category='Toys' ORDER BY id ASC";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="toyssession.php?action=add&id=<?php echo $row["id"]; ?>">  
