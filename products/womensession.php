...
<body>
  ...
  <a href="../session.php">Home</a>
      ...
      <a href="womensession.php" class="active">Women</a>
      <a href="kidssession.php" >Kids</a>
      <a href="electronicssession.php">Electronics</a>
	...
	<div class="banner">
		<div class="banner-layer">
			<h1 class="title-w3layouts">
				<span class="fa fa-cart-arrow-down" aria-hidden="true"></span>Women's collection</h1>
		</div>
		...
		<div class="wthreeproductdisplay">
           ...
           <div class="container" style="width:700px;">  
                <?php  
                $query = "SELECT * FROM tbl_product where category='Women' ORDER BY id ASC";  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="womensession.php?action=add&id=<?php echo $row["id"]; ?>">  
