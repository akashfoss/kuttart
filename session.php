...
<body>
  ...
  <a href="session.php" class="active">Home</a>
      <a href="products/mensession.php">Men</a>
      <a href="products/womensession.php">Women</a>
      <a href="products/kidssession.php">Kids</a>
      <a href="products/electronicssession.php">Electronics</a>
      <a href="products/toyssession.php">Toys</a>
		...
		<!-- cart's-Product-Display -->
		 <br />  
           <div class="container" style="width:700px;">  
                ...
                ?>  
                <div class="col-md-4">  
                     <form method="post" action="session.php?action=add&id=<?php echo $row["id"]; ?>">  
