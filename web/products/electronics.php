...
<body>
  ...
  <a href="../../index.php">Home</a>
    ...
    <div class="dropdown-content">
      ...
      <a href="electronics.php" class="activeyellow">Electronics</a>
			...
			<div class="container">
				<div class="top-grid">
					<div class="cart-grid" id="cart-1">
						<div class="img">
							<img src="../images/e1.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$60.00</li>
					...
					<div class="cart-grid" id="cart-2">
						<div class="img">
							<img src="../images/e2.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
					...
					<div class="cart-grid" id="cart-3">
						<div class="img">
							<img src="../images/e3.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$40.00</li>
					...
					<div class="cart-grid" id="cart-4">
						<div class="img">
							<img src="../images/e4.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
							<li class="right-text">$195.00</li>
				...
				<div class="bot-grid">
					<div class="cart-grid" id="cart-5">
						<div class="img">
							<img src="../images/e5.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$20.00</li>
					...
					<div class="cart-grid" id="cart-7">
						<div class="img">
							<img src="../images/e7.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$25.00</li>
