...
<body>
  ...
  <a href="../index.php">Home</a>
    ...
    <div class="dropdown-content">
      ...
      <a href="kids.php" class="activeyellow">Kids</a>
	...
	<div class="banner">
		<div class="banner-layer">
			<h1 class="title-w3layouts">
				<span class="fa fa-cart-arrow-down" aria-hidden="true"></span>Kid's collection</h1>
		</div>
			...
			<div class="container">
				<div class="top-grid">
					...
					<div class="cart-grid" id="cart-2">
						<div class="img">
							<img src="../images/k2.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
					...
					<div class="cart-grid" id="cart-3">
						<div class="img">
							<img src="../images/k3.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$40.00</li>
					...
					<div class="cart-grid" id="cart-4">
						<div class="img">
							<img src="../images/k4.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
							<li class="right-text">$195.00</li>
				...
				<div class="bot-grid">
					<div class="cart-grid" id="cart-5">
						<div class="img">
							<img src="../images/k5.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$20.00</li>
					...
					<div class="cart-grid" id="cart-6">
						<div class="img">
							<img src="../images/k8.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$50.00</li>
							<li class="right-text">$95.00</li>
					...
					<div class="cart-grid" id="cart-7">
						<div class="img">
							<img src="../images/k6.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$25.00</li>
