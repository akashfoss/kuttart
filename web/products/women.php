...
<body>
  ...
  <a href="../index.php">Home</a>
    ...
    <div class="dropdown-content">
      ...
      <a href="women.php" class="activeyellow">Women</a>
			...
			<div class="container">
				<div class="top-grid">
					...
					<div class="cart-grid" id="cart-4">
						<div class="img">
							<img src="../images/w4.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
							<li class="right-text">$195.00</li>
				...
				<div class="bot-grid">
					...
					<div class="cart-grid" id="cart-6">
						<div class="img">
							<img src="../images/w6.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$50.00</li>
							<li class="right-text">$95.00</li>
					...
					<div class="cart-grid" id="cart-7">
						<div class="img">
							<img src="../images/w7.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$25.00</li>
					...
					<div class="cart-grid" id="cart-8">
						<div class="img">
							<img src="../images/w8.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$36.00</li>
