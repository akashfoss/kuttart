...
<body>
  ...
  <a href="../index.php">Home</a>
    ...
    <div class="dropdown-content">
      <a href="men.php" class="activeyellow">Men</a>
			...
			<div class="container">
				<div class="top-grid">
					<div class="cart-grid" id="cart-1">
						<div class="img">
							<img src="../images/men1.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$60.00</li>
					...
					<div class="cart-grid" id="cart-2">
						<div class="img">
							<img src="../images/men5.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
					...
					<div class="cart-grid" id="cart-3">
						<div class="img">
							<img src="../images/men3.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$40.00</li>
					...
					<div class="cart-grid" id="cart-4">
						<div class="img">
							<img src="../images/men4.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
							<li class="right-text">$195.00</li>
				...
				<div class="bot-grid">
					...
					<div class="cart-grid" id="cart-6">
						<div class="img">
							<img src="../images/men6.jpg" alt="img">
						</div>
						<ul class="info">
							<li>$50.00</li>
							<li class="right-text">$95.00</li>
