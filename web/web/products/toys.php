...
<body>
  ...
  <a href="../index.php">Home</a>
    ...
    <div class="dropdown-content">
      ...
      <a href="toys.php" class="activeyellow">Toys</a>
    </div>
  </div>
	...
	<div class="banner">
		<div class="banner-layer">
			<h1 class="title-w3layouts">
				<span class="fa fa-cart-arrow-down" aria-hidden="true"></span>Toy's collection</h1>
		</div>
			...
			<div class="container">
				<div class="top-grid">
					<div class="cart-grid" id="cart-1">
						<div class="img">
							<img src="../images/t1.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$60.00</li>
					...
					<div class="cart-grid" id="cart-3">
						<div class="img">
							<img src="../images/t3.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$40.00</li>
					...
					<div class="cart-grid" id="cart-4">
						<div class="img">
							<img src="../images/t4.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$95.00</li>
							<li class="right-text">$195.00</li>
				...
				<div class="bot-grid">
					...
					<div class="cart-grid" id="cart-7">
						<div class="img">
							<img src="../images/t7.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$25.00</li>
					...
					<div class="cart-grid" id="cart-8">
						<div class="img">
							<img src="../images/t8.jpeg" alt="img">
						</div>
						<ul class="info">
							<li>$36.00</li>
